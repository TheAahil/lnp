...
jalan("\033[1;91m--------------------- DEAR USER DONT USE OLD ACCOUNT TO LOGIN")
jalan("\033[1;91m--------------------- IF YOUR CONTRY IS INDIA USE SUPER VPN ANY PROXY")
jalan("\033[1;91m--------------------- IF YOU USE WIFI INSTALL SUPER VPN AN USE PROXXY")
jalan("\033[1;91m--------------------- USE NEW ID TO LOGIN")
jalan("\033[1;91m--------------------- WELOME TO AAHIL CREATIONS SUBSCRIBE US")
jalan("\033[1;96m   ___  _")                      
jalan("\033[1;96m  / __\| |  ___   _ __    ___  _ __")
